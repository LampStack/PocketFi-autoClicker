            ...
            try:
                if check_base_url() is False:
                    ...
                    if settings.ADVANCED_ANTI_DETECTION:
                        logger.warning(
                            "<yellow>Detected index js file change. Contact me to check if it's safe to continue: https://t.me/LampStack</yellow>")
                    else:
                        logger.warning(
                            "<yellow>Detected api change! Stoped the bot for safety. Contact me here to update the bot: https://t.me/LampStack</yellow>")
